...
def test():
    assert Solution().giveGem([3, 1, 2], [[0, 2], [2, 1], [2, 0]]) == 2
    assert Solution().giveGem([100, 0, 50, 100], [[0, 2], [0, 1], [3, 0], [3, 0]]) == 75
    assert Solution().giveGem([0, 0, 0, 0], [[1, 2], [3, 1], [1, 2]]) == 0
